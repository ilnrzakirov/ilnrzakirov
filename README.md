...
| ------------- |:------------------------:| ------------------------:|
| [matcha](https://github.com/ilnrzakirov/matcha)  |  Because, love too can be industrialized. (web tinder)  | Python 3.10, FastAPI, uvicorn, pip-tools, database, logging, pydantic, pre-commit, flake8, isort, SQLAlchemy, JWT, FastAPIUser |
